...
HD_PWD='C:/Users/winiarcc/ECE/SecurityDevice/SecurityDevice.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DisplayController_LiveTest.vds -m64 -mode batch -messageDb vivado.pb -notrace -source DisplayController_LiveTest.tcl
