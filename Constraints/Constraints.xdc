...
#set_property PACKAGE_PIN R7 [get_ports {L}]					
...
#set_property PACKAGE_PIN V9 [get_ports {rb}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {rb}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports {rc}]					
...
#set_property PACKAGE_PIN U1 [get_ports {la}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {la}]
#Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {lb}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {lb}]
#Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
#set_property PACKAGE_PIN P2 [get_ports {lc}]					
